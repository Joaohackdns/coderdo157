        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4 class="title mb-2">Separador de CC</h4>
              <textarea style="height: 8.06rem;" class="form-control text-center form-checker mb-2" placeholder="Insira Sua Lista (999)"></textarea>
  ...
  $(document).ready(function() {
   ...
   // getSaldo();
    ...
    $('.btn-play').click(function() {
      new Audio('https://pladixoficial.xyz/audios/irra.ogg').play();
        ...
        var callBack = $.ajax({
          ...
          success: function(retorno) {
            if (retorno.indexOf("") >= 0) {
              ...
              removelinha();
              new Audio('https://pladixoficial.xyz/audios/delicia.ogg').play();
              lives = lives +1;
            } else {
